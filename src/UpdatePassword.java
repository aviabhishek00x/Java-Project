...
public class UpdatePassword extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "update register set pass_word = '"+pass.getText()+"' where username='"+username+"'";
            Statement st2 = con.createStatement();
            String sql2 = "update login set pasword = '"+pass.getText()+"' where username='"+username+"'";
             if ( pass.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please enter password.");
        } else if (pass.getText().length() < 8 && pass.getText().length()>13) {
        ...
        cnfPass.setText("");
         ...
         pass.setText("");
         cnfPass.setText("");
        } else if (!pass.getText().matches(".*[a-z].*")) {
        ...
        else if(pass.getText().equals(cnfPass.getText())){
            JOptionPane.showConfirmDialog(this, "Are You Sure You Want To Submit....");
